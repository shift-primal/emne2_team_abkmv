            ...
            <form class="edit-recipe-form">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        step="0.5"
                        value="${recipe.rating}"
                        data-action="update-rating-display"
                    />
                ...
                <div class="form-group">
                    ...
                    ${recipe.ingredients
                        ...
                        .join("")}
                    <button type="button" class="btn btn-primary" data-action="add-new-ingredient">
                        Legg Til Ingrediens
                    </button>
                </div>
                ...
                <div class="form-group">
                    ...
                    ${recipe.recipeSteps
                        ...
                        .join("")}
                    <button type="button" class="btn btn-primary" data-action="add-new-step">
                        Legg Til Steg
                    </button>
                </div>

                <div class="btn-group">
                    <button type="button" class="btn btn-primary" data-action="save-recipe">
                        Lagre
                    </button>
